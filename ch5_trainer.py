...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 29 02:04:01 2022

Trainer and tester functions for chapter 5 experiments.
...
class Trainer(object):
    ...
    def train(self, curriculum=False):
        ...
        for epoch in range(self.start_epoch, self.C.training.epochs):
            ...
            # Curriculum
            if curriculum and epoch%25 == 0 and epoch != 0:
                stage += 1
                print("\nEntering curriculum stage {}".format(
                stage))
